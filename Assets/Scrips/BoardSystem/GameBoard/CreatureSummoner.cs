...
//    public bool SummonCreature(Opponent player, Card card, FieldVisual field, FieldManager fieldManager) {
//        FieldVisual gridField = fieldManager.ValidateSummon(player, field);
...
//    private bool TryCreateBattleCreature(Card card, FieldVisual field, out BattleCreature battleCreature) {
...
//    private void CreateCreatureUI(Card card, FieldVisual field) {
